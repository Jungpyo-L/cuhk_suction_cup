...
class Coordinate_Calculator(object):
    ...
    def __init__(
        ...
        fov_y=60,
        neighbor_size=3,
        foreground_max_depth=1200,
        max_neighbor_size=10,
        image_pose_delay=0,
    ):
        """
        ...
        self.fov_y = fov_y
        self.f_x = (self.width / 2) / math.tan(
            0.5 * math.pi * self.fov_x / 180
        )  # focal length of the Kinect camera
    ...
    def get_depth_coordinate(self, image_frames, position_frames):
        ...
        for img, poses in zip(image_frames, position_frames):
            ...
            for x, y in poses:
                ...
                z = 9999999999
                while (
                    z >= self.foreground_max_depth and _radius <= self.max_neighbor_size
                ):
