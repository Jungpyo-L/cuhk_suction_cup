...
class Kinect_Openpose_Pipeline(object):
    ...
    def __init__(
        self,
        image_holefilling=None,
        image_denoising=None,
        tranjectory_crop=None,
        tranjectory_smooth=None,
        motion_sampler=None,
        coordinate_calculator=None,
    ):
        """
        ...
        """
        self.image_holefilling = (
            image_holefilling if image_holefilling is not None else HoleFilling_Filter()
        )
        self.tranjectory_crop = (
            tranjectory_crop if tranjectory_crop is not None else Crop_Filter()
        )
        self.coordinate_calculator = (
            coordinate_calculator
            if coordinate_calculator is not None
            else Coordinate_Calculator()
        )
    ...
    def __call__(self, image_frame, openpose_frame):
        ...
        coordinate = self.coordinate_calculator.get_depth_coordinate(
            image_frame, openpose_frame
        )
